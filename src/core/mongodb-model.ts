...
class MongoDbConnection {
    ...
    static connect() {
        this.init();
        const params = {dbName: "fatecsp20191ihc", useNewUrlParser: true};
...
export abstract class MongoDbModel<T extends Model> implements PersistedModel<T> {
    ...
    create(data: T | T[]): Promise<T[]> {
        return new Promise((resolve, reject) => {
            this.__model.create(Array.isArray(data) ? data : [data], (error, data) =>  {
    ...
    findById(id: any, projection?: any): Promise<T | null> {
        return new Promise((resolve, reject) => {
            ...
            this.__model.findById(id, projection).lean().exec((error, data) =>  {
                if (error) return reject(error);
    ...
    findOne(condition?: any, projection?: any): Promise<T | null> {
        return new Promise((resolve, reject) => {
            this.__model.findOne(condition, projection).lean().exec((error, data) => {
                if (error) return reject(error);
                resolve(data);
            });
        });
    ...
    find(condition?: any, projection?: any): Promise<T[]> {
        return new Promise((resolve, reject) => {
            this.__model.find(condition, projection).lean().exec((error, data) => {
                if (error) return reject(error);;
                resolve(data);
            });
        });
    ...
    updateMany(condition: any, data: T): Promise<{}> {
        return new Promise((resolve, reject) => {
            this.__model.updateMany(condition, data).lean().exec((error, data) => {
                if (error) return reject(error);
                resolve(data);
            });
        });
    ...
    updateOne(condition: any, data: any): Promise<{}> {
        return new Promise((resolve, reject) => {
            this.__model.updateOne(condition, data, (error, data) => {
                if (error) return reject(error);
                resolve(data);
            });
        });
    ...
    removeMany(condition: any): Promise<{}> {
        return new Promise((resolve, reject) => {
            this.__model.deleteMany(condition, (error) => {
                if (error) return reject(error);
                resolve();
            });
        });
    ...
    removeOne(condition: any): Promise<{}> {
        return new Promise((resolve, reject) => {
            this.__model.deleteOne(condition, (error) => {
                if (error) return reject(error);
                resolve();
            });
        });
    ...
    replaceOne(id: any, replacement: T): Promise<T> {
        return new Promise((resolve, reject) => {
            this.__model.replaceOne({_id: id}, replacement, (error) => {
                if (error) return reject(error);
                resolve(replacement);
            });
        });
